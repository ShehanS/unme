...
public class AddServiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(TextUtils.isEmpty(CompanyName)){
                ...
                Service service = new Service(sessionUserID,CompanyName, FirstName, LastName, ContactNumber, Email, Address, Website, Category, currentDate, Amount, Message, true, true);
